    ...
    $(document).ready(function() {
        ...
        contact_form.on("submit", function(event) {
            ...
            grecaptcha.ready(function() {
                      ...
                      grecaptcha.execute('6LdQIX8UAAAAAFL6nTrxm-6GDFTxq9uA1FQNevLz', {action: 'create_request'}).then(function(token) {
                          // add token to form
                          var submit            = $('submit', contact_form);
                          var ajaxResponse      = $('#contact-response');
                          var name              = $('[name="name"]', contact_form).val();
                          var email             = $('[name="email"]', contact_form).val();
                          var phone           = $('[name="phone"]', contact_form).val();
                          var address           = $('[name="address"]', contact_form).val();
                          var crop           = $('[name="crop"]', contact_form).val();
                          ...
                          $.ajax({
                              ...
                              beforeSend: function(result) {
                                  //submit.empty();
                                  //ajaxResponse.append('<i class="fa fa-cog fa-spin"></i> Wait...');
                              },
